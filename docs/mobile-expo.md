...
| EAS archive                 | Current SDK 57 archive passed for 96 files and 1,665,547 bytes, every byte matching current source; SDK 56 and SDK 55 archive receipts remain historical                                                                     | Upload or EAS builder receipt                                             |
...
| `check:eas-archive`       | Passed; 96 files, 1,665,547 bytes (~1.59 MiB)                 | Fresh allowlisted archive; every byte matches current source; local archive evidence only                                                     |
...
current SDK 57 archive contains 96 files totaling 1,665,547 bytes (about
