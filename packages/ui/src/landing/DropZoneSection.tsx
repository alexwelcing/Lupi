        ...
        <svg width="80" height="80" style={{ marginBottom: 20 }}>
          ...
          <circle
            ...
            style={{
              ...
              filter: 'drop-shadow(0 0 8px rgba(216,184,120,0.45))',
            }}
          />
        </svg>
        <div
        ...
        >
          ...
          <span
            style={{
              ...
              background: error
                ? 'rgba(239,68,68,0.1)'
                : dragOver
                  ? 'linear-gradient(135deg, #d8b878, #b98cae)'
          ...
          <span
            ...
            style={{
              display: 'block',
              fontSize: 14,
              color: error ? 'rgba(248,113,113,0.9)' : 'rgba(255,255,255,0.48)',
              marginBottom: 24,
              lineHeight: 1.5,
            }}
          >
            {error ||
              'Drag files here or choose from your device — LAMMPS, XYZ, trajectories, logs, and profiles.'}
            {error && (
              <span
                style={{
                  display: 'block',
              ...
              >
                Choose or drop another file to try again.
              </span>
            )}
          </span>
