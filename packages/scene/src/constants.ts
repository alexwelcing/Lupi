...
export const COLORMAPS: Record<ColormapName, (t: number) => [number, number, number]> = {
  ...
  ocean:     makeColormap([0.0, 0.2, 0.4],       [0.0, 0.5, 0.6],       [0.2, 0.8, 0.8],       [0.8, 0.95, 1.0]),
  fire:      makeColormap([0.1, 0.0, 0.0],       [0.8, 0.2, 0.0],       [1.0, 0.7, 0.0],       [1.0, 1.0, 0.8]),
  ice:       makeColormap([0.0, 0.05, 0.2],      [0.0, 0.3, 0.7],       [0.4, 0.7, 0.9],       [0.9, 0.95, 1.0]),
  forest:    makeColormap([0.05, 0.15, 0.05],    [0.1, 0.4, 0.1],       [0.4, 0.7, 0.2],       [0.8, 0.9, 0.5]),
  cyberpunk: makeColormap([0.1, 0.0, 0.3],       [0.6, 0.0, 0.6],       [0.0, 0.8, 0.9],       [1.0, 0.1, 0.6]),
  autumn:    makeColormap([0.2, 0.0, 0.0],       [0.6, 0.1, 0.0],       [0.9, 0.5, 0.1],       [1.0, 0.9, 0.4]),
  grayscale: makeColormap([0.0, 0.0, 0.0],       [0.33, 0.33, 0.33],    [0.66, 0.66, 0.66],    [1.0, 1.0, 1.0]),
  turbo:     makeColormap([0.18, 0.07, 0.40],    [0.12, 0.66, 0.72],    [0.85, 0.88, 0.18],    [0.85, 0.15, 0.11]),
};
